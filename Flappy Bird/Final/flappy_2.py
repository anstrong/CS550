...
class Avatar(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # Load avatar image
        self.file = pygame.image.load('Resources/Characters/flappy-bird.png')

        self.image =  pygame.transform.scale(self.file, (35, 35))
        if self.type == 'nyan-cat':
            self.image =  pygame.transform.scale(self.file, (38, 25))
        elif self.type == 'unicorn':
            self.image =  pygame.transform.scale(self.file, (48, 35))
...
class Flappy_Bird(Avatar):
    ...
    def crash(self):
        Avatar.crash(self)
        image = pygame.image.load('Resources/Characters/flappy-bird_crash.png')
...
class Fish(Avatar):
    def __init__(self):
        # Initialize parent class
        Avatar.__init__(self)
        self.file = pygame.image.load('Resources/Characters/fish.png')
        self.acceleration = 1/5
        self.image =  pygame.transform.scale(self.file, (35, 30))
