...
class Pipe_Pair():
    def __init__(self, gap_height, x, avatar_type):
        ...
        self.Top_Pipe = Pipe(-1, 315 - (self.gap_size + self.gap_height), self.x, avatar_type)
...
def home():
    ...
    Flappy_Bird_Button = Avatar_Button('Resources/Characters/flappy-bird.png', 290, 175, 'flappy-bird')
...
def check_alive():
    ...
    if Character.rect.y <= 300 and (start-now) > .1:
        alive = False
        game_over()
