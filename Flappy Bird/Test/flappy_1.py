...
class Avatar(pygame.sprite.Sprite):
    ...
    def crash(self):
        ...
        if self.type == 'flappy-bird':
            ...
            self.image =  pygame.transform.scale(image, (35, 35))
        #elif self.type == 'nyan-cat':
            #self.image =  pygame.transform.scale(image, (52, 35))
        #elif self.type == 'unicorn':
            #self.image =  pygame.transform.scale(image, (52, 35))
...
class Rainbow():
    def __init__(self, y):
        ...
        rainbow_image = pygame.image.load('Resources/Characters/nyan-cat_rainbow.png')
        self.image = pygame.transform.scale(rainbow_image, (35, 10))
...
class Trail():
    def __init__(self):
        for i in range(0, 5):
            y = self.y
            x = self.x
            self.rainbow_y.append(Rainbow(y))
            self.rainbow_x.append(x)
    ...
    def pan(self):
        ...
        for i in range(0, 5):
            ...
            if self.rainbow_x[i] < -100:
                del(self.rainbow_x[i])
                del(self.rainbow[i])

    def print(self):
        # Send newly positioned images to screen
        for i in range(0, 5):
            self.rainbow[i].print(self.x[i])
